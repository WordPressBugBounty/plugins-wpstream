...
* Fix - LearnDash product custom fields work when WpStream is active

= 4.12.3 =
* Fix - Missing live channel player elements
...
* Fix - Fatal error caused by the demo options

= 4.12 =
* Enhancement - Use a new structure for VOD for a loading time and quality

= 4.11.4 =
* Enhancement - Hook custom menu items into the WC menu
* Fix - Start/Stop streaming using the go_live shortcode
* Fix - Unecessary HLS playback URL

= 4.11.3 =
* Enhancement - Player loading time
* Fix - Broken style of the channel offline message change
* Fix - Default channel settings

= 4.11.2 =
* Enhancement - Security improvements on frontend dashboard
* Fix - Downloads section missing from the My Account dashboard
* Fix - Terms and Conditions link on the signup form

= 4.11.1 =
* Tested up to WordPress 6.9.1

= 4.11 =
* Feature - Add closed captions option to the VODs
* Enhancement - Optimize onboarding steps for smoother user experience
* Enhancement - Broadcaster style on mobile
* Fix - Update rewrite rule logic for better performance
* Fix - Wrong channel status message on player
...
* Fix - Update the broadcaster rewriting rules
* Enhancement - Update the POT file

= 4.8.1 =
* Fix - Broadcaster reconnecting issue

= 4.8 =
* Improvement - Broadcaster experience improvements
* Improvement - Extend channel settings functionality
* Enhancement - Update requests to WpStream API
* Fix - Missing translations and updating the POT file

= 4.7.2 =
* Fix - Issue with closing the onboarding wizard
...
* Fix - Initial Video Player message when the streaming has started

= 4.6.7.8 =
* Improvement - Decrease number of remote requests

= 4.6.7.7 =
* Fix - Fatal error due to loading wrong PHP file

= 4.6.7.6 =
* Enhancement - Moved functionality from the Hello WpStream theme to the plugin

= 4.6.7.5 =
* Enhancement - Added the support tab in the settings area for environment status and logs
* Fix - Show the option to turn on the channel only on published channels
...
* Enhancement - Automatically save changes on the plugin settings

= 4.6.7.2 =
* Fix - Styling of the play button over the player
* Enhancement - Register custom WooCommerce products
...
= 4.6.6.9 =
* Fix - WpStream shortcodes not working
...
= 4.6.6.1 =
* Fix - display error when plugin registration times out
